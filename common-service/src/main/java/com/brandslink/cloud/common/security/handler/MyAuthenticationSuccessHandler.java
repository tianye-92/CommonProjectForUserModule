...
public class MyAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        if (StringUtils.equals(platformType, "0")) {
            ...
            redisUtils.remove(UserConstant.PLATFORM_TYPE_ACCOUNT_REDIS_USER_TOKEN_KEY_FIX_WMS + username);
            ...
            redisUtils.remove(UserConstant.PLATFORM_TYPE_ACCOUNT_REDIS_USER_TOKEN_KEY_FIX_OMS + username);
