...
public class MenuInfoServiceImpl implements IMenuInfoService {
    ...
    public void addTopNode(AddTopMenuInfoRequestDTO requestDTO) {
        verifyNameAndPosition(0, requestDTO.getName(), requestDTO.getBelong());
     ...
     * @param name
     */
    private void verifyNameAndPosition(Integer parentId, String name, Integer belong) {
        if (StringUtils.isNotBlank(name)) {
            // 判断部门名称是否重复
            Integer count = mapper.selectNameByParentId(name, parentId, belong);
    ...
    public void addSubNode(Integer parentId, AddTopMenuInfoRequestDTO requestDTO) {
        verifyNameAndPosition(parentId, requestDTO.getName(), requestDTO.getBelong());
    ...
    public void updateNodeDetail(Integer id, AddTopMenuInfoRequestDTO requestDTO) {
        verifyNameAndPosition(id, requestDTO.getName(), requestDTO.getBelong());
    ...
    @Override
    public List<MenuInfoResponseDTO> getTreeOfMenus(Integer id, Integer flag) {
        List<MenuInfo> infoList = mapper.selectAllByUserIdOfMenus(id, flag);
    ...
    public List<MenuInfoResponseDTO> getTreeOfMenusByUserId(Integer id, Integer flag) {
        List<MenuInfoResponseDTO> result = getTreeOfMenus(id, flag);
