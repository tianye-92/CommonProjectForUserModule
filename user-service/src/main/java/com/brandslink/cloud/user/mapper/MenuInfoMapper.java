...
public interface MenuInfoMapper extends BaseMapper<MenuInfo> {
     ...
     * @return
     */
    Integer selectNameByParentId(@Param("name") String name, @Param("parentId") Integer parentId, @Param("belong") Integer belong);
     ...
     * @return
     */
    List<MenuInfo> selectAllByUserIdOfMenus(@Param("id") Integer id, @Param("flag") Integer flag);
